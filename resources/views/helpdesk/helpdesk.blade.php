      ...
      <div class="col-md-4">
        <div class="card shadow-sm h-100 text-center">
          ...
          <div class="card-body d-flex flex-column">
            ...
            <a href="tutor1.html" class="btn btn-primary mt-auto">Lihat Panduan</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card shadow-sm h-100 text-center">
          ...
          <div class="card-body d-flex flex-column">
            ...
            <a href="tutor2.html" class="btn btn-primary mt-auto">Lihat Panduan</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card shadow-sm h-100 text-center">
          ...
          <div class="card-body d-flex flex-column">
            ...
            <a href="tutor3.html" class="btn btn-primary mt-auto">Lihat Panduan</a>
          </div>
        </div>
      </div>
